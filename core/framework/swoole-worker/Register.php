...
use HP\Swoole\Library\Config;
use HP\Swoole\Library\SockServer;
...
class Register extends Service
{
    ...
    public function __construct(string $register_host = '0.0.0.0', int $register_port = 1236)
    {
        parent::__construct();
        ...
        }, '/var/run/' . str_replace('/', '_', array_pop($debug)['file']) . '.sock');
    ...
    {
        $server = new SwooleServer($this->register_host, $this->register_port, SWOOLE_PROCESS, SWOOLE_SOCK_TCP);
